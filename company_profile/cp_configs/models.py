...
class BrandIdentity(models.Model):
    ...
    sidebar_scripts = models.TextField(blank=True)
    horizontal_banner_scripts = models.TextField(blank=True)
    vertical_banner_scripts = models.TextField(blank=True)
    infeed_ads_scripts = models.TextField(blank=True)
    ads_scripts = models.TextField(blank=True)
    tracking_scripts = models.TextField(blank=True)
    other_scripts = models.TextField(blank=True)
